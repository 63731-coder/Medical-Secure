                        ...
                        <div class="flex-1">
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">@{{ patient.user.username }}</p>
                                </div>
                            </div>
                            <div class="mt-3 space-y-1 text-sm">
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <span class="text-xs">Born: {{ new Date(patient.date_of_birth).toLocaleDateString() }}</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <span class="text-xs">{{ patient.user.email }}</span>
                                </div>
                                <div v-if="patient.phone_number" class="flex items-center text-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    <span class="text-xs">{{ patient.phone_number }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="ml-2">
